            ...
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" sticky="top">
                <Container>
                    ...
                    <Navbar.Collapse className="justify-content-end">
                        ...
                        <Nav.Link as={HashLink} to="/home#places-to-visit">PlacesYouCanVisit</Nav.Link>
                        <Nav.Link as={HashLink} to="/home#ourguides">OurGuides</Nav.Link>
                        <Nav.Link as={HashLink} to="/allbookings">ManageAllBookings</Nav.Link>
                        {/* <Nav.Link as={HashLink} to="/booking">Bookings</Nav.Link> */}
                        {user?.email && <Nav.Link as={HashLink} to="/addservice">AddService</Nav.Link>}
